...
function medical_clinic_register_theme_js_scripts() {
	...
	wp_localize_script('medical-clinic-theme-script', 'cmsmasters_theme_script', $cmsmasters_localize_array);
}

add_action('wp_enqueue_scripts', 'medical_clinic_register_theme_js_scripts');
	...
	$form = "<div class=\"search_bar_wrap\">
		<form method=\"get\" action=\"" . esc_url(home_url('/')) . "\">
			<p class=\"search_field\">
				...
				<input type=\"submit\" value=\"post\" id=\"search\" name=\"post_type\" class=\"d-none\" />
			</p>
			<p class=\"search_button\">
				<label for=\"search\" class=\"cmsmasters_theme_icon_search\"></label>
			</p>
		</form>
	</div>";
