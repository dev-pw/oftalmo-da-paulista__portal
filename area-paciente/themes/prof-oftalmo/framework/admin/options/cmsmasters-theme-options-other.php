...
function medical_clinic_get_custom_other_meta_fields() {
	...
	$cmsmasters_global_layout = (isset($cmsmasters_option['medical-clinic' . '_layout']) && $cmsmasters_option['medical-clinic' . '_layout'] !== '') ? $cmsmasters_option['medical-clinic' . '_layout'] : 'fullwidth';
