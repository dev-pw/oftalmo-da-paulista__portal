    ...
    <div class="row">
            ...
            <div class="row px-3 px-lg-0 gap-4 justify-content-between">
                <article class="mb-3 col-lg bg-light rounded-0 p-4 text-center">
                    ...
                    <div class="row g-2 mt-3 justify-content-center">
                        <div class="col-auto">
                            <a class="btn btn-primary text-white" href="https://www.google.com/maps/dir//Sociedade+Brasileira+de+Oftalmologia+Pedi%C3%A1trica+-+SBOP+-+R.+Casa+do+Ator,+1117+-+Conjunto+21+-+Vila+Ol%C3%ADmpia,+S%C3%A3o+Paulo+-+SP,+04546-004/@-23.5842132,-46.6887044,14z/data=!4m8!4m7!1m0!1m5!1m1!1s0x94ce57227f736ad3:0x91c99ed6f84aa0df!2m2!1d-46.6837812!2d-23.5969425?entry=ttu" target="_blank" title="Como chegar pelo Google Maps">Maps</a>
                        </div>
                        <div class="col-auto">
                            <a class="btn btn-primary text-white" href="https://www.waze.com/pt-PT/live-map/directions/br/sp/r.-casa-do-ator,-1117?to=place.ChIJ1y_Pwk5XzpQRuiwFRH85DZ0" target="_blank" title="Como chegar pelo Waze">Waze</a>
                        </div>
                    </div>
                </article>
                <article class="mb-3 col-lg bg-light rounded-0 py-4 px-3 text-center d-flex flex-column justify-content-center">
                    ...
                    <div class="my-2 text-center">
                        <a href="tel:+551155764000">(11) 5576-4000</a>
        ...
        <div class="col-lg-4 pt-5">
            ...
            data-action="contato/inserir" method="POST">
                ...
                <input type="text" class="w-100 mb-2" id="campo-nome" name="nome" required placeholder="Nome">
                <input type="email" class="w-100 mb-2" id="campo-email" name="email" required placeholder="E-mail">
                <input type="text" class="w-100 mb-2 tel_mask" id="campo-telefone" name="telefone" required placeholder="Telefone">
                <input type="text" class="w-100 mb-2" id="campo-assunto" name="assunto" required placeholder="Assunto">
                <textarea cols="" class="w-100 mb-2" id="campo-mensagem" name="mensagem" required rows="7" placeholder="Mensagem"></textarea>
                <div>
