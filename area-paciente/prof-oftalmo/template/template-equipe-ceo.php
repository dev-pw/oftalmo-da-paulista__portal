...
<section class="py-5">
    <div class="container">
        ...
        <div class="row gy-5">
            ...
            <?php if( have_rows('item_equipe_ceo') ):  while ( have_rows('item_equipe_ceo') ) : the_row(); ?>
            <div class="col-12 col-sm-6 col-xl-3">
                ...
                <div class="p-3 shadow h-100">
                    ...
                    <div>
                        ...
                        <p class="mb-2 pb-0 text-center" style="font-size: 14px;"><?php the_sub_field('texto_1'); ?></p>
                        <p class="mb-2 pb-0 text-center" style="font-size: 14px;"><?=$descricao; ?></p>
