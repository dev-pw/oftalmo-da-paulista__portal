...
<section class="py-5">
    ...
    <div class="mt-3">
        <p>Para todos os candidatos aprovados na 1ª Fase do Processo Seletivo 2023/2024</p>
        <a href="<?= the_permalink(15105); ?>" target="_blank" class="btn btn-primary my-3">Formulário Análise Curricular Prévia</a>
    </div>
    ...
    <div class="mt-5">
        <ul class="nav nav-pills mb-3 gap-3" id="pills-tab" role="tablist">
            ...
            <li class="nav-item p-0" role="presentation">
                <button class="nav-link" id="pills-r3-tab" data-bs-toggle="pill" data-bs-target="#pills-r3" type="button" role="tab" aria-controls="pills-r3" aria-selected="false">R3 - Ano Opcional</button>
            </li>
            <li class="nav-item p-0" role="presentation">
