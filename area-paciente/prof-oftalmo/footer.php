                ...
                <div class="col-md-6 d-md-block">
                    ...
                    <div class="row mt-4 justify-content-center justify-content-lg-start align-items-center">
                        <div class="col-4 col-md-6 col-lg-4">
                            <?php echo wp_get_attachment_image( 15475, 'full', "", ["class" => "img-fluid", "style" => "width: 160px ;" ]); ?>
                        </div>
                        <div class="col-4 col-md-6 col-lg-4">
                            <?php echo wp_get_attachment_image( 15476, 'full', "", ["class" => "img-fluid", "style" => "width: 165px;"]); ?>
                        </div>
                        <div class="col-4 col-md-6 col-lg-3">
                            <?php echo wp_get_attachment_image( 15414, 'full', "", ["class" => "img-fluid"]); ?>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-5 d-md-flex flex-md-column align-items-md-end text-white">
                    <div class="text-center text-md-start">
                        ...
                        <div class="justify-content-center justify-content-lg-start row gy-2    ">
                            <div class="col-auto">
                                <a href="https://www.google.com/maps/dir//Sociedade+Brasileira+de+Oftalmologia+Pedi%C3%A1trica+-+SBOP+-+R.+Casa+do+Ator,+1117+-+Conjunto+21+-+Vila+Ol%C3%ADmpia,+S%C3%A3o+Paulo+-+SP,+04546-004/@-23.5842132,-46.6887044,14z/data=!4m8!4m7!1m0!1m5!1m1!1s0x94ce57227f736ad3:0x91c99ed6f84aa0df!2m2!1d-46.6837812!2d-23.5969425?entry=ttu" target="_blank" class="btn btn-light link-primary">Maps</a>
                            </div>
                            <div class="col-auto">
                                <a href="https://www.waze.com/pt-PT/live-map/directions/br/sp/r.-casa-do-ator,-1117?to=place.ChIJ1y_Pwk5XzpQRuiwFRH85DZ0" target="_blank" class="btn btn-outline-light">Waze</a>
                            </div>
                        </div>
