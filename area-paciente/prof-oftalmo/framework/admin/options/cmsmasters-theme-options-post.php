...
function medical_clinic_get_custom_post_meta_fields() {
	...
	$cmsmasters_global_blog_post_layout = (isset($cmsmasters_option['medical-clinic' . '_blog_post_layout']) && $cmsmasters_option['medical-clinic' . '_blog_post_layout'] !== '') ? $cmsmasters_option['medical-clinic' . '_blog_post_layout'] : 'fullwidth';
