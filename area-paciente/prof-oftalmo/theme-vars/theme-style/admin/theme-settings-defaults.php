...
function medical_clinic_settings_general_defaults($id = false) {
	$settings = array( 
		...
		'content' => array( 
			'medical-clinic' . '_layout' => 				'fullwidth', 
			'medical-clinic' . '_archives_layout' => 		'fullwidth', 
			'medical-clinic' . '_search_layout' => 			'fullwidth', 
			'medical-clinic' . '_other_layout' => 			'fullwidth', 
...
function medical_clinic_settings_single_defaults($id = false) {
	$settings = array( 
		'post' => array( 
			'medical-clinic' . '_blog_post_layout' => 		'fullwidth', 
