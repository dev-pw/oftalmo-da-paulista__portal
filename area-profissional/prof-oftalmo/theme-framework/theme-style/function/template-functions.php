	...
	if (is_404() || is_home()) {
		...
		if (
			...
			echo "<div class=\"headline cmsmasters_color_scheme_{$cmsmasters_heading_scheme}\">
				<div class=\"bg-page-header headline_outer" . ($cmsmasters_heading == 'disabled' ? ' cmsmasters_headline_disabled' : '') . "\">
					<div class=\"headline_color\"></div>";
			
			
			if ($cmsmasters_heading != 'disabled') {
				echo "<div class=\"headline_inner container align_{$cmsmasters_heading_alignment}\">
				...
				if ($cmsmasters_heading == 'custom') {
					...
					if (is_search()) {
						...
						if (!empty($wp_query->found_posts)) {
							echo sprintf(esc_html(_n('%1$d Resultados de pesquisa por: %2$s', '%1$d Resultados de pesquisa por: %2$s', $wp_query->found_posts, 'medical-clinic')), $wp_query->found_posts, get_search_query());
						} else {
							echo sprintf(esc_html__('0 Resultados de pesquisa por: %s', 'medical-clinic'), get_search_query());
						}
					} elseif (is_archive()) {
						if (is_author()) {
