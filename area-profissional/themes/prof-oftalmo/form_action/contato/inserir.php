...
checarVazio($tipo); // mesmo id do input
checarVazio($motivo); // mesmo id do input
...
try {
  ...
  // INSERT
  $stmt = $pdo->prepare('
    INSERT INTO oft23_contato (
      nome_contato, email_contato, tel_contato, tipo_contato, motivo_contato, mensagem_contato
    ) VALUES (
      :nome_contato, :email_contato, :tel_contato, :tipo_contato, :motivo_contato, :mensagem_contato
    )');
  $stmt->execute(array(
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellspacing="2" cellpadding="10" style="background-color:#ffffff; font-size:14px; font-family: Verdana; color: #525252; line-height: 1.5">
                    <tbody>
                      ...
                      <tr>
                        <td width="120" valign="top" bgcolor="#f6f6f6"><p><strong>Tipo:</strong></p></td>
                        <td valign="top" bgcolor="#f6f6f6">'.$tipo.'</td>
                      </tr>
                      <tr>
                        <td width="120" valign="top" bgcolor="#f6f6f6"><p><strong>Motivo:</strong></p></td>
                        <td valign="top" bgcolor="#f6f6f6">'.$motivo.'</td>
                      </tr>
                      <tr>
