jQuery(document).ready(function ($) {
  ...
  let url = document.querySelector("#getUrl").getAttribute('data-url');
    ...
    /*=======================================================
      FORMULÁRIO DE cadastro
    =========================================================*/
    $('.form_transplante').submit(function (evt) {
      evt.preventDefault();
      ...
      let configForm = {
        ...
        mostrar_mensagem: true,
        texto_sucesso: "Cadastro concluido com sucesso",
        desc_sucesso: "Redirecionando..",
        redirect: true,
        link_redirect_dinamico: false,
        link_redirect: url+'/sucesso/',
        redirect_com_var: false,
        variaveis: null
      }
    ...
    /*=======================================================
      FORMULÁRIO DE AVALIACAO
    =========================================================*/
    $('.form_avaliacao').submit(function (evt) {
      evt.preventDefault();
      ...
      let configForm = {
        texto_botao: "Enviar",
        mostrar_mensagem: true,
        texto_sucesso: "Avaliação enviada com sucesso",
        desc_sucesso: "Sua avaliação será analisada e entraremos em contato em breve!",
        redirect: false,
        link_redirect_dinamico: false,
        link_redirect: '',
        redirect_com_var: false,
    ...
    /*=======================================================
      FORMULÁRIO DE AVALIACAO
    =========================================================*/
    $('.form_prog_oftalmo').submit(function (evt) {
      evt.preventDefault();
      ...
      let configForm = {
        texto_botao: "Enviar",
        mostrar_mensagem: true,
        texto_sucesso: "Programa enviada com sucesso",
        desc_sucesso: "Seu programa de residência será analisada e entraremos em contato em breve!",
        redirect: false,
        link_redirect_dinamico: false,
        link_redirect: '',
        redirect_com_var: false,
