...
function enqueue_scripts(){
	...
	// FontAwasome
	wp_enqueue_style('fontawesome', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css', array(), $tema_version, 'all');
	...
	// Animate Css
	wp_enqueue_style('animate', 'https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css', array(), $tema_version, 'all');

	// Bootstrap JS
	wp_enqueue_script( 'bootstrap', 'https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js', array('jquery'), $tema_version, true );
	wp_enqueue_script( 'bootstrap-min', 'https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.min.js', array('jquery'), $tema_version, true );

	// Theme JS
	wp_enqueue_script( 'mask-js', 'https://cdnjs.cloudflare.com/ajax/libs/jquery.mask/1.14.16/jquery.mask.min.js', array('jquery'), $tema_version, true );
	wp_enqueue_script( 'form', get_template_directory_uri().'/js/forms.js', array('jquery'), $tema_version, true );
	wp_enqueue_script( 'theme', get_template_directory_uri().'/js/theme.js', array('jquery'), $tema_version, true );
...
define('CMSMASTERS_PROJECT_COMPATIBLE', false);

// Theme Profiles Compatibility
define('CMSMASTERS_PROFILE_COMPATIBLE', false);
...
// Barra de opções de cada page, post
