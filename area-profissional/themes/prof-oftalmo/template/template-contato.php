    ...
    <div class="row">
        ...
        <div class="col-lg-4 pt-5">
            ...
            enctype="multipart/form-data">
                ...
                <input class="w-100 mb-2" name="nome" required type="text" placeholder="Nome">
                <input class="w-100 mb-2" name="email" required type="email" placeholder="E-mail">
                <input  class="w-100 mb-2 tel_mask"name="telefone" required type="text" placeholder="Telefone">
                <select id="tipo" class="w-100 mb-2" name="tipo" required aria-required="true">
                    <option disabled="disabled" selected="selected">Você é:</option>
                    <option>Aluno</option>
                    <option>Médico</option>
                    <option>Outro</option>
                </select>
                <select id="motivo" class="w-100 mb-2" name="motivo" required aria-required="true">
                    <option disabled="disabled" selected="selected">Motivo</option>
                ...
                <textarea id="campo-mensagem" cols="" class="w-100 mb-2" name="mensagem" required rows="7" placeholder="Mensagem"></textarea>
                <div>
            ...
            <a href="/paciente" target="_blank" class="btn btn-primary w-100 py-2 mt-3">Sou Paciente</a>
